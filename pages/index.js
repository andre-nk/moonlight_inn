  ...
  return (
    <div className="flex flex-col min-h-screen max-w-full py-0 overflow-hidden bg-white">
      ...
      <div className="top-0 -m-1 min-w-full bg-primary relative lg:py-10">
        ...
        <h2 className="text-2xl px-12 pt-16 lg:pt-0 font-header font-semibold">
          Featured Resources
        </h2>
        <div>
      ...
      >
        <div className="pt-8 pb-24 flex-column">
          ...
          <p className="font-body text-md mb-2 text-center mx-14 lg:mx-64 leading-8">
          ...
          <a
            ...
            href="https://www.buymeacoffee.com/fullstackdre"
            target="_blank"
          >
            <Image
              height="57.5px"
        ...
        <div className="bg-primary w-full h-80 my-8 flex z-0 justify-center items-center lg:w-1/2 lg:relative">
          <div className="flex-column justify-center">
            ...
            <p className="text-md font-body pt-3 pb-5 leading-6 pl-1">
              Get updated for our{" "}
              brand-new D&D resource releases, <br />
