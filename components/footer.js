const Footer = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row py-5 px-16 bg-footer justify-between z-20" >
            <a href={privacyPolicyURL} target="_blank" rel="noopener" className="text-white self-center">Privacy Policy</a>
            <p className="text-white self-center py-2 lg:py-0">Copyright 2021; Moonlight Inn</p>
            <a href={mailURL} target="_blank" rel="noopener" className="text-white self-center">moonlightinnsupport@gmail.com</a>
        </div>
    );
}
